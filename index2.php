...
<!DOCTYPE html>
<!-- Designined by Yashvi Jhade PA56 -->
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> PA56 WTL Mini Project </title>
...
<section class="about" id="about">
  ...
  <div class="about-details">
    ...
    <div class="right">
      ...
      <div class="button">
        <button onclick="window.open('Design CV.pdf','_blank')">Download CV</button>
        <!-- <button>
 ...
 <div class="content">
   ...
   <div class="skills-details">
     <div class="text">
       ...
       <p>CODING-JAVA, CSS, HTML, C, MYSQL</p>
       <div class="video">
...
<footer>
  <div class="text">
    <span>Created By <a href="#">Yashvi Jhade PA56</a></span>
  </div>
</footer>
